...
@tool("Makes the arm look at the largest object with the specified label, will return false if the arm cannot perceive any objects with that label", label="The label of the object to look at")
